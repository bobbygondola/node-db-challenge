...
**Relational Databases are databses and SQL is the langage that we use to query.. easy

- [ ] Why do tables need a `primary key`?
** they nee a priamry key to distingush them frm eachcother.. an id..

- [ ] What is the name given to a table column that references the primary key on another table.
** a foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
** a joint table.. a seperate table that helps spread data
